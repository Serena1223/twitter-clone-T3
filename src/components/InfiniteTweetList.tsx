...
type InfiniteTweetListProps = {
  ...
  isError: boolean;
  hasMore: boolean;
  fetchNewTweets: () => Promise<unknown>; // a function that returns a promose of some type
  tweets?: Tweet[];
};
export function InfiniteTweetList({
  ...
  return (
    <ul>
      ...
      >
        {tweets.map((tweet) => {
          return <TweetCard key={tweet.id} {...tweet} />; //key is a unique identifier for elements in a list (in this case a tweet)
        })}
      </InfiniteScroll>
    </ul>
  );
